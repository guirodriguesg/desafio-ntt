...
public class UsuarioController {
    ...
    @GetMapping
    private Page<UsuarioResponse> getAllUsers(@PageableDefault(sort = {"nome"}) Pageable pageable) {
        log.info("Buscando todos os usuarios");
        return usuarioService.getAllUsers(pageable).map(usuarioMapper::toUsuarioResponse);
    }
